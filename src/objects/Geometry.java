...
public final class Geometry
{
  ...
  public static double computeAnglePoint (double[] p0, double[] p1, double[] p2)
  {
    int centerX = new Double(p0[0]).intValue();
    int centerY = new Double(p0[1]).intValue();
    
    int pointOneX  = new Double(p1[0]).intValue();
    int pointOneY  = new Double(p1[1]).intValue();
    
    int pointTwoX  = new Double(p2[0]).intValue();
    int pointTwoY  = new Double(p2[1]).intValue();
